...
(function () {
  ...
  // Český kalendář jmen — jméno, které má ten den svátek
  const SVATKY = {
    ...
    '3-11':'Anděla','3-12':'Řehoř','3-13':'Růžena','3-14':'Rút','3-15':'Ida','3-16':'Elena','3-17':'Vlastimil','3-18':'Eduard','3-19':'Josef','3-20':'Světlana',
    ...
    '4-1':'Hugo','4-2':'Erika','4-3':'Richard','4-4':'Ivana','4-5':'Miroslava','4-6':'Vendula','4-7':'Heřman','4-8':'Ema','4-9':'Dušan','4-10':'Darja',
    ...
    '6-1':'Laura','6-2':'Jarmil','6-3':'Tamara','6-4':'Dalibor','6-5':'Dobroslav','6-6':'Norbert','6-7':'Iveta','6-8':'Medard','6-9':'Stanislava','6-10':'Gita',
    ...
    '7-1':'Jaroslava','7-2':'Patricie','7-3':'Radomír','7-4':'Prokop','7-5':'Cyril a Metoděj','7-6':'Mistr Jan Hus','7-7':'Bohuslava','7-8':'Nora','7-9':'Drahoslava','7-10':'Libuše',
    ...
    '8-1':'Oskar','8-2':'Gustav','8-3':'Miluše','8-4':'Dominik','8-5':'Kristián','8-6':'Oldřiška','8-7':'Lada','8-8':'Soběslav','8-9':'Roman','8-10':'Vavřinec',
    '8-11':'Zuzana','8-12':'Klára','8-13':'Alena','8-14':'Alan','8-15':'Hana','8-16':'Jáchym','8-17':'Petra','8-18':'Helena','8-19':'Ludvík','8-20':'Bernard',
    '8-21':'Johana','8-22':'Bohuslav','8-23':'Sandra','8-24':'Bartoloměj','8-25':'Radim','8-26':'Luděk','8-27':'Otakar','8-28':'Augustýn','8-29':'Evelína','8-30':'Vladěna','8-31':'Pavlína',
    '9-1':'Linda','9-2':'Adéla','9-3':'Bronislav','9-4':'Jindřiška','9-5':'Boris','9-6':'Boleslav','9-7':'Regína','9-8':'Mariana','9-9':'Daniela','9-10':'Irma',
    '9-11':'Denisa','9-12':'Marie','9-13':'Lubor','9-14':'Radka','9-15':'Jolana','9-16':'Ludmila','9-17':'Naděžda','9-18':'Kryštof','9-19':'Zita','9-20':'Oleg',
    '9-21':'Matouš','9-22':'Darina','9-23':'Berta','9-24':'Jaromír','9-25':'Zlata','9-26':'Andrea','9-27':'Jonáš','9-28':'Václav','9-29':'Michal','9-30':'Jeroným',
    '10-1':'Igor','10-2':'Olívie','10-3':'Bohumil','10-4':'František','10-5':'Eliška','10-6':'Hanuš','10-7':'Justýna','10-8':'Věra','10-9':'Štefan','10-10':'Marina',
    ...
    '10-21':'Brigita','10-22':'Sabina','10-23':'Teodor','10-24':'Nina','10-25':'Beáta','10-26':'Erik','10-27':'Šarlota','10-28':'Den vzniku ČSR','10-29':'Silvie','10-30':'Tadeáš','10-31':'Štěpánka',
    '11-1':'Felix','11-2':'Památka zesnulých','11-3':'Hubert','11-4':'Karel','11-5':'Miriam','11-6':'Liběna','11-7':'Saskie','11-8':'Bohumír','11-9':'Bohdan','11-10':'Evžen',
    '11-11':'Martin','11-12':'Benedikt','11-13':'Tibor','11-14':'Sáva','11-15':'Leopold','11-16':'Otmar','11-17':'Den boje za svobodu','11-18':'Romana','11-19':'Alžběta','11-20':'Nikola',
    ...
    '12-11':'Dana','12-12':'Simona','12-13':'Lucie','12-14':'Lýdie','12-15':'Radana','12-16':'Albína','12-17':'Daniel','12-18':'Miloslav','12-19':'Ester','12-20':'Dagmar',
    '12-21':'Natálie','12-22':'Šimon','12-23':'Vlasta','12-24':'Štědrý den','12-25':'1. svátek vánoční','12-26':'Štěpán','12-27':'Žaneta','12-28':'Bohumila','12-29':'Judita','12-30':'David','12-31':'Silvestr'
  };

  function formatDateShort(d) {
    const dni = ['neděle','pondělí','úterý','středa','čtvrtek','pátek','sobota'];
    const mes = ['ledna','února','března','dubna','května','června','července','srpna','září','října','listopadu','prosince'];
    return `${dni[d.getDay()]} ${d.getDate()}. ${mes[d.getMonth()]}`;
  }
  function svatekToday(d) {
    return SVATKY[(d.getMonth()+1) + '-' + d.getDate()] || '';
  }
  ...
  function renderHeader() {
    ...
    const svatek = svatekToday(new Date());
    ...
    el.innerHTML = `
      <header class="masthead">
        <div class="meta-l">
          ${today}<br/>
          <span class="svatek-label">svátek má</span> <b>${svatek}</b>
        </div>
        <h1 class="brand">
